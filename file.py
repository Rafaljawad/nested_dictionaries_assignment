...
def iterate_dictionary(list,key1,key2):
  for dictionary in range(len(students)):
    # print(students[dictionary].items())
    print(f"{key1}-{students[dictionary][key1]},{key2}-{students[dictionary][key2]}")
...
def iterate_dictionary2(key,list=students):
  for dictionary in range(len(students)):
    print(students[dictionary][key])
iterate_dictionary2('first_name')
iterate_dictionary2('last_name')
...
dojo = {
    ...
    'instructors': [
        'Michael', 'Amy', 'Eduardo', 'Josh', 'Graham', 'Patrick', 'Minh',
        'Devon'
    ]
}
